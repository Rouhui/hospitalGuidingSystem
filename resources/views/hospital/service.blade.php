    ...
    <div class="col-md-3">
        <div class="left-part">
            <div class="list-group">
                ...
                <a href="{{ route('service',['type'=>'schedule']) }}" class="list-group-item {{ strstr( Request::getPathInfo(), 'schedule')? 'active': '' }}"><i class="icon-user-md"></i>门诊排班</a>
                ...
                <a href="{{ route('service',['type'=>'queryReport']) }}" class="list-group-item {{ Request::getPathInfo() == '/Home/Service/queryReport'? 'active': '' }}"><i class="icon-list-alt"></i>报告单查询</a>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        ...
                        @elseif( strstr( Request::getPathInfo(), 'schedule') )
                            门诊排班
                        @elseif( strstr( Request::getPathInfo(), 'queryReport') )
                            报告单查询
                        @endif
                    </li>
                </ol>
